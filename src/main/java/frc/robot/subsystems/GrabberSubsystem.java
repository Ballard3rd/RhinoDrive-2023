...
public class GrabberSubsystem extends SubsystemBase {
  ...
  private final CANSparkMax m_rightMotor = new CANSparkMax(GrabberConstants.kRightGrabberCanId, MotorType.kBrushless);
  ...
  public GrabberSubsystem() {
    ...
    m_leftMotor.setInverted(GrabberConstants.kGrabberLeftEncoderInverted);
    m_rightMotor.setInverted(GrabberConstants.kGrabberRightEncoderInverted);
